...
class UserRepository extends BaseRepository
{
    ...
    public function getEmailForPasswordToken($token)
    {
        ...
        throw new GeneralException(_tr('auth.unknown'));
    }
    ...
    public function findOrCreateSocial($data, $provider)
    {
        ...
        if (!$user) {
            ...
            if (!config('access.users.registration')) {
                throw new GeneralException(_tr('exceptions.frontend.auth.registration_disabled'));
            }
    ...
    public function confirmAccount($token)
    {
        ...
        if ($user->confirmed == 1) {
            throw new GeneralException(_tr('exceptions.frontend.auth.confirmation.already_confirmed'));
        }
        ...
        throw new GeneralException(_tr('exceptions.frontend.auth.confirmation.mismatch'));
    }
        ...
        if ($user->canChangeEmail()) {
            ...
            if ($user->email != $input['email']) {
                ...
                if ($this->findByEmail($input['email'])) {
                    throw new GeneralException(_tr('exceptions.frontend.auth.email_taken'));
                }
    ...
    public function changePassword($input)
    {
        ...
        throw new GeneralException(_tr('exceptions.frontend.auth.password.change_mismatch'));
    }
