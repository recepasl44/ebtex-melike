...
class MenuRepository extends BaseRepository
{
    ...
    public function create(array $input)
    {
        if ($this->query()->where('name', $input['name'])->first()) {
            throw new GeneralException(_tr('exceptions.backend.menus.already_exists'));
        }
        ...
        throw new GeneralException(_tr('exceptions.backend.menus.create_error'));
    }
    ...
    public function update(Menu $menu, array $input)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.menus.update_error'));
    }
    ...
    public function delete(Menu $menu)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.menus.delete_error'));
    }
}
