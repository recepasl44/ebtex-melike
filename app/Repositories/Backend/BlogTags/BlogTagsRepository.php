...
class BlogTagsRepository extends BaseRepository
{
    ...
    public function create(array $input)
    {
        if ($this->query()->where('name', $input['name'])->first()) {
            throw new GeneralException(_tr('exceptions.backend.blogtags.already_exists'));
        }
        ...
        DB::transaction(function () use ($input) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogtags.create_error'));
        });
    }
    ...
    public function update(BlogTag $blogtag, array $input)
    {
        ...
        DB::transaction(function () use ($blogtag, $input) {
            ...
            throw new GeneralException(
                _tr('exceptions.backend.blogtags.update_error')
            );
        });
    }
    ...
    public function delete(BlogTag $blogtag)
    {
        DB::transaction(function () use ($blogtag) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogtags.delete_error'));
        });
    }
}
