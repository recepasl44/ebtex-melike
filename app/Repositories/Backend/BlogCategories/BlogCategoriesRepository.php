...
class BlogCategoriesRepository extends BaseRepository
{
    ...
    public function create(array $input)
    {
        if ($this->query()->where('name', $input['name'])->first()) {
            throw new GeneralException(_tr('exceptions.backend.blogcategories.already_exists'));
        }
        ...
        DB::transaction(function () use ($input) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogcategories.create_error'));
        });
    }
    ...
    public function update(BlogCategory $blogcategory, array $input)
    {
        ...
        DB::transaction(function () use ($blogcategory, $input) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogcategories.update_error'));
        });
    }
    ...
    public function delete(BlogCategory $blogcategory)
    {
        DB::transaction(function () use ($blogcategory) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogcategories.delete_error'));
        });
    }
}
