...
class PagesRepository extends BaseRepository
{
    ...
    public function getForDataTable()
    {
        return $this->query()
            ...
            ->select([
                ...
                config('module.pages.table').'.lang',
    ...
    public function create(array $input)
    {
        if ($this->query()->where('title', $input['title'])->first()) {
            throw new GeneralException(_tr('exceptions.backend.pages.already_exists'));
        }
        ...
        throw new GeneralException(_tr('exceptions.backend.pages.create_error'));
    }
    ...
    public function update($page, array $input)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.pages.update_error'));
    }
    ...
    public function delete($page)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.pages.delete_error'));
    }
}
