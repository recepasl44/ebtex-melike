...
class BlogsRepository extends BaseRepository
{
    ...
    {
        $this->upload_path = 'img'.DIRECTORY_SEPARATOR;
    ...
    public function getForDataTable()
    {
        return $this->query()
            ...
            ->select([
                ...
                config('module.blogs.table').'.lang',
    ...
    public function create(array $input)
    {
        ...
        DB::transaction(function () use ($input, $tagsArray, $categoriesArray) {
            ...
            $input = $this->uploadImage($input, 'blog', 'featured_image');
            ...
            throw new GeneralException(_tr('exceptions.backend.blogs.create_error'));
        });
    }
    ...
    public function update(Blog $blog, array $input)
    {
        ...
        DB::transaction(function () use ($blog, $input, $tagsArray, $categoriesArray) {
            ...
            throw new GeneralException(
                _tr('exceptions.backend.blogs.update_error')
            );
        });
    }
    ...
    public function delete(Blog $blog)
    {
        DB::transaction(function () use ($blog) {
            ...
            throw new GeneralException(_tr('exceptions.backend.blogs.delete_error'));
        });
    }
}
