...
class PermissionRepository extends BaseRepository
{
    ...
    public function create(array $input)
    {
        if ($this->query()->where('name', $input['name'])->first()) {
            throw new GeneralException(_tr('exceptions.backend.access.permissions.already_exists'));
        }
        ...
        DB::transaction(function () use ($input) {
            ...
            throw new GeneralException(_tr('exceptions.backend.access.permissions.create_error'));
        });
    }
    ...
    public function update($permission, array $input)
    {
        ...
        DB::transaction(function () use ($permission, $input) {
            ...
            throw new GeneralException(_tr('exceptions.backend.access.permission.update_error'));
        });
    }
    ...
    public function delete($permission)
    {
        DB::transaction(function () use ($permission) {
            ...
            throw new GeneralException(_tr('exceptions.backend.access.permission.delete_error'));
        });
    }
}
