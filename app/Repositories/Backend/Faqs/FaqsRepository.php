...
class FaqsRepository extends BaseRepository
{
    ...
    public function create(array $input)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.faqs.create_error'));
    }
    ...
    public function update(Faq $faq, array $input)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.faqs.update_error'));
    }
    ...
    public function delete(Faq $faq)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.faqs.delete_error'));
    }
    ...
    public function mark(Faq $faq, $status)
    {
        ...
        throw new GeneralException(_tr('exceptions.backend.access.faqs.mark_error'));
    }
}
