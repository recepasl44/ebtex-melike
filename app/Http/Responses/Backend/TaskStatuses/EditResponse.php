...
{
    /**
     * @var App\Models\TaskStatuses\TaskStatus
     */
    protected $taskstatuses;

    /**
     * @param App\Models\TaskStatuses\TaskStatus $taskstatuses
     */
    public function __construct($taskstatuses)
    {
    ...
    public function toResponse($request)
    {
        ...
        return view('backend.taskstatuses.edit',compact('tasks', 'statuses'))->with([
