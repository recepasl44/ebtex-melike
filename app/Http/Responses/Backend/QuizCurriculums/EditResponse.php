...
{
    /**
     * @var App\Models\QuizCurriculums\QuizCurriculum
     */
    protected $quizcurriculums;

    /**
     * @param App\Models\QuizCurriculums\QuizCurriculum $quizcurriculums
     */
    public function __construct($quizcurriculums)
    {
        $this->quizcurriculums = $quizcurriculums;
    }
    ...
    public function toResponse($request)
    {
        ...
        return view('backend.quizcurriculums.edit',compact('quiztypes', 'lessons', 'units', 'chapters', 'topics', 'achievements', ))->with([
            'quizcurriculums' => $this->quizcurriculums
        ]);
    }
}