...
{
    /**
     * @var App\Models\ScheduledAssignments\ScheduledAssignment
     */
    protected $scheduledassignments;

    /**
     * @param App\Models\ScheduledAssignments\ScheduledAssignment $scheduledassignments
     */
    public function __construct($scheduledassignments)
    {
    ...
    public function toResponse($request)
    {
        ...
        return view('backend.scheduledassignments.edit',compact('programs', 'levels', 'lessons', 'units', 'chapters', 'topics', 'achievements', 'sources', ))->with([
            'scheduledassignments' => $this->scheduledassignments
        ]);
    }
}