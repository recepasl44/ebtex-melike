...
{
    /**
     * @var App\Models\StudentGroups\StudentGroup
     */
    protected $studentgroups;

    /**
     * @param App\Models\StudentGroups\StudentGroup $studentgroups
     */
    ...
    public function toResponse($request)
    {
        ...
        return view('backend.studentgroups.edit',compact('students', 'groups', ))->with([
