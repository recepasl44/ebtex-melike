...
class BlogsController extends Controller
{
    ...
    public function store(StoreBlogsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogs.index'), ['flash_success' => _tr('alerts.backend.blogs.created')]);
    }
    ...
    public function update(Blog $blog, UpdateBlogsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogs.index'), ['flash_success' => _tr('alerts.backend.blogs.updated')]);
    }
    ...
    public function destroy(Blog $blog, ManageBlogsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogs.index'), ['flash_success' => _tr('alerts.backend.blogs.deleted')]);
    }
}
