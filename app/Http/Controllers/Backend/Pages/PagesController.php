...
class PagesController extends Controller
{
    ...
    public function store(StorePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.pages.index'), ['flash_success' => _tr('alerts.backend.pages.created')]);
    }
    ...
    public function update(Page $page, UpdatePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.pages.index'), ['flash_success' => _tr('alerts.backend.pages.updated')]);
    }
    ...
    public function destroy(Page $page, DeletePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.pages.index'), ['flash_success' => _tr('alerts.backend.pages.deleted')]);
    }
}
