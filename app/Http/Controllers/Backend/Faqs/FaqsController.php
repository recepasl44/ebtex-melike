...
class FaqsController extends Controller
{
    ...
    public function store(StoreFaqsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.faqs.index'), ['flash_success' => _tr('alerts.backend.faqs.created')]);
    }
     ...
     */
    public function edit($id, EditFaqsRequest $request)
    {
    ...
    public function update(UpdateFaqsRequest $request, $id)
    {
        ...
        return new RedirectResponse(route('admin.faqs.index'), ['flash_success' => _tr('alerts.backend.faqs.updated')]);
    }
     ...
     * @return \App\Http\Responses\RedirectResponse
     */
    public function destroy($id, DeleteFaqsRequest $request)
    {
        $faq = $this->faq->find($id);
        $this->faq->delete($faq);

        return new RedirectResponse(route('admin.faqs.index'), ['flash_success' => _tr('alerts.backend.faqs.deleted')]);
    }
}
