...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.role.index'), ['flash_success' => _tr('alerts.backend.roles.created')]);
    }
    ...
    public function update(Role $role, UpdateRoleRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.role.index'), ['flash_success' => _tr('alerts.backend.roles.updated')]);
    }
    ...
    public function destroy(Role $role, DeleteRoleRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.role.index'), ['flash_success' => _tr('alerts.backend.roles.deleted')]);
    }
}
