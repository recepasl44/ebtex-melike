...
class UserController extends Controller
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.user.index'), ['flash_success' => _tr('alerts.backend.users.created')]);
    }
    ...
    public function update(User $user, UpdateUserRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.user.index'), ['flash_success' => _tr('alerts.backend.users.updated')]);
    }
    ...
    public function destroy(User $user, DeleteUserRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.user.index'), ['flash_success' => _tr('alerts.backend.users.deleted')]);
    }
}
