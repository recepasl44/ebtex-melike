...
class PermissionController extends Controller
{
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.permission.index'), ['flash_success' => _tr('alerts.backend.permissions.created')]);
    }
    ...
    public function update(Permission $permission, UpdatePermissionRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.permission.index'), ['flash_success' => _tr('alerts.backend.permissions.updated')]);
    }
    ...
    public function destroy(Permission $permission, DeletePermissionRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.access.permission.index'), ['flash_success' => _tr('alerts.backend.permissions.deleted')]);
    }
}
