...
class BlogTagsController extends Controller
{
    ...
    public function store(StoreBlogTagsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogTags.index'), ['flash_success' => _tr('alerts.backend.blogtags.created')]);
    }
    ...
    public function update(BlogTag $blogTag, UpdateBlogTagsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogTags.index'), ['flash_success' => _tr('alerts.backend.blogtags.updated')]);
    }
    ...
    public function destroy(BlogTag $blogTag, DeleteBlogTagsRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogTags.index'), ['flash_success' => _tr('alerts.backend.blogtags.deleted')]);
    }
}
