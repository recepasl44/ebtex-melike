...
class MenuController extends Controller
{
    ...
    public function store(StoreMenuRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.menus.index'), ['flash_success' => _tr('alerts.backend.menus.created')]);
    }
    ...
    public function update(Menu $menu, UpdateMenuRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.menus.index'), ['flash_success' => _tr('alerts.backend.menus.updated')]);
    }
    ...
    public function destroy(Menu $menu, DeleteMenuRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.menus.index'), ['flash_success' => _tr('alerts.backend.menus.deleted')]);
    }
}
