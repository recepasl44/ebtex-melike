...
class BlogCategoriesController extends Controller
{
    ...
    public function store(StoreBlogCategoriesRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogCategories.index'), ['flash_success' => _tr('alerts.backend.blogcategories.created')]);
    }
    ...
    public function update(BlogCategory $blogCategory, UpdateBlogCategoriesRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogCategories.index'), ['flash_success' => _tr('alerts.backend.blogcategories.updated')]);
    }
    ...
    public function destroy(BlogCategory $blogCategory, DeleteBlogCategoriesRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.blogCategories.index'), ['flash_success' => _tr('alerts.backend.blogcategories.deleted')]);
    }
}
