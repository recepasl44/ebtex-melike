...
class RegisterController extends Controller
{
    ...
    public function register(RegisterRequest $request)
    {
        /*if (config('access.users.confirm_email')) {
            ...
            return redirect($this->redirectPath())->withFlashSuccess(_tr('exceptions.frontend.auth.confirmation.created_confirm'));
        } else {
        ...
        if (config('access.users.confirm_email') || config('access.users.requires_approval')) {
            ...
            return redirect($this->redirectPath())->withFlashSuccess(
                config('access.users.requires_approval') ?
                    _tr('exceptions.frontend.auth.confirmation.created_pending') :
                    _tr('exceptions.frontend.auth.confirmation.created_confirm')
            );
        } else {
