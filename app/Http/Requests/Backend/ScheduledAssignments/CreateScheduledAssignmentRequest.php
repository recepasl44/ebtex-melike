...
namespace App\Http\Requests\Backend\ScheduledAssignments;

use Illuminate\Foundation\Http\FormRequest;

class CreateScheduledAssignmentRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-scheduledassignment');
    }
