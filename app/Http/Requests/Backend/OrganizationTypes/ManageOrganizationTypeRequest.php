...
namespace App\Http\Requests\Backend\OrganizationTypes;

use Illuminate\Foundation\Http\FormRequest;

class ManageOrganizationTypeRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-organizationtype');
    }
