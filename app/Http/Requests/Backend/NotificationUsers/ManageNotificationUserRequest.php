...
namespace App\Http\Requests\Backend\NotificationUsers;

use Illuminate\Foundation\Http\FormRequest;

class ManageNotificationUserRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-notificationuser');
    }
