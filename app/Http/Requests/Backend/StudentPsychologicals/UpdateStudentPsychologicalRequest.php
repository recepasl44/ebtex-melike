...
namespace App\Http\Requests\Backend\StudentPsychologicals;

use Illuminate\Foundation\Http\FormRequest;

class UpdateStudentPsychologicalRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-studentpsychological');
    }
