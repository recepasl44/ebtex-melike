...
namespace App\Http\Requests\Backend\GuidanceObservations;

use Illuminate\Foundation\Http\FormRequest;

class CreateGuidanceObservationRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-guidanceobservation');
    }
