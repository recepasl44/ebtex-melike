...
namespace App\Http\Requests\Backend\QuestionDifficults;

use Illuminate\Foundation\Http\FormRequest;

class UpdateQuestionDifficultRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-questiondifficult');
    }
