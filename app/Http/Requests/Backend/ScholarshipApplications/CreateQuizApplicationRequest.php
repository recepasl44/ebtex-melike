...
namespace App\Http\Requests\Backend\ScholarshipApplications;

use Illuminate\Foundation\Http\FormRequest;

class CreateScholarshipApplicationRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-scholarshipapplication');
    }
