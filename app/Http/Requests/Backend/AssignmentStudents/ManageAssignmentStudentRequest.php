...
namespace App\Http\Requests\Backend\AssignmentStudents;

use Illuminate\Foundation\Http\FormRequest;

class ManageAssignmentStudentRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-assignmentstudent');
    }
