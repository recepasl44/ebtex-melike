...
namespace App\Http\Requests\Backend\OrganizationLinks;

use Illuminate\Foundation\Http\FormRequest;

class DeleteOrganizationLinkRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('delete-organizationlink');
    }
