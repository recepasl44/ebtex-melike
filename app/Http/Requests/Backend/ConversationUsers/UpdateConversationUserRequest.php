...
namespace App\Http\Requests\Backend\ConversationUsers;

use Illuminate\Foundation\Http\FormRequest;

class UpdateConversationUserRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-conversationuser');
    }
