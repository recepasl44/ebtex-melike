...
namespace App\Http\Requests\Backend\ScholarshipSettings;

use Illuminate\Foundation\Http\FormRequest;

class ManageScholarshipSettingRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-scholarshipsetting');
    }
