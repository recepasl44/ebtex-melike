...
namespace App\Http\Requests\Backend\EmployeeAcademics;

use Illuminate\Foundation\Http\FormRequest;

class CreateEmployeeAcademicRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-employeeacademic');
    }
