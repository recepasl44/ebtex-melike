...
namespace App\Http\Requests\Backend\QuestionCurriculums;

use Illuminate\Foundation\Http\FormRequest;

class CreateQuestionCurriculumRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-questioncurriculum');
    }
