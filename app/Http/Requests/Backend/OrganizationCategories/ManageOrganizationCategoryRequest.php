...
namespace App\Http\Requests\Backend\OrganizationCategories;

use Illuminate\Foundation\Http\FormRequest;

class ManageOrganizationCategoryRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-organizationcategory');
    }
