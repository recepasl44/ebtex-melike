...
namespace App\Http\Requests\Backend\AttendanceTeachers;

use Illuminate\Foundation\Http\FormRequest;

class DeleteAttendanceTeacherRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('delete-attendanceteacher');
    }
