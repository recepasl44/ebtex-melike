...
namespace App\Http\Requests\Backend\ScholarshipDocuments;

use Illuminate\Foundation\Http\FormRequest;

class DeleteScholarshipDocumentRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('delete-scholarshipdocument');
    }
