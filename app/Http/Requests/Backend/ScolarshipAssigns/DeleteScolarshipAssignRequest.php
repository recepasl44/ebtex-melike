...
namespace App\Http\Requests\Backend\ScolarshipAssigns;

use Illuminate\Foundation\Http\FormRequest;

class DeleteScolarshipAssignRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('delete-scolarshipassign');
    }
