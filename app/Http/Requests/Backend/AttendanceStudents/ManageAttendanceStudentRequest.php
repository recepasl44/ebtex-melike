...
namespace App\Http\Requests\Backend\AttendanceStudents;

use Illuminate\Foundation\Http\FormRequest;

class ManageAttendanceStudentRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-attendancestudent');
    }
