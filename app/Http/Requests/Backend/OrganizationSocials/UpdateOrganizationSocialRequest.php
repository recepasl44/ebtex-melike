...
namespace App\Http\Requests\Backend\OrganizationSocials;

use Illuminate\Foundation\Http\FormRequest;

class UpdateOrganizationSocialRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-organizationsocial');
    }
