...
namespace App\Http\Requests\Backend\OpticalAttributes;

use Illuminate\Foundation\Http\FormRequest;

class CreateOpticalAttributeRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-opticalattribute');
    }
