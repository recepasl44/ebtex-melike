...
namespace App\Http\Requests\Backend\ContractEmployees;

use Illuminate\Foundation\Http\FormRequest;

class DeleteContractEmployeeRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('delete-contractemployee');
    }
