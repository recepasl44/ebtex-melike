...
import png26 from "../../../../assets/images/ecommerce/png/26.png"
import png24 from "../../../../assets/images/ecommerce/png/24.png"
import png27 from "../../../../assets/images/ecommerce/png/27.png"

const MyDatePicker = () => {
    const [_selectedDate, setSelectedDate] = React.useState<Date | string>('');
    ...
    return (
        <>
            ...
            <SpkFlatpickr inputClass='form-control flatpickr-input'
...
const steps = [
    ...
    },
    {
        ...
        description:
            (
                <div className='wizard-step wizard-tab container'>
                    ...
                    <Row className='wizard-content container'>
                        <Col xl={12}>
                            <div className="checkout-payment-success">
                                ...
                                <div className="mb-4">
                                    <img src={png24} alt="" className="img-fluid" />
                                </div>
                                <div className="mb-4">
                                ...
                                <Link to="#!" className="btn btn-success">Book Another Appointment</Link>
                            </div>
                        </Col>
                    </Row>
                </div>
