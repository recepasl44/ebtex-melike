...
import { generateStudentData } from "../../../../../../utils/generateStudentData.ts";

interface Row12Props {
  data: DashboardResponseType;
}

const Row12Component: React.FC<Row12Props> = ({ data }) => {
  ...
  const Cardsdata = generateStudentData(data);
    ...
    <Row>
      ...
      <Col xl={9} xxl={9}>
        <LeftSection
          ...
          numberOfFinalizedAssignments={numberOfCompletedAssignments}
          serviceInformation={serviceInformation}
          weeklyLessonScheduleData={weeklyLessonScheduleData}
        />
      </Col>
