...
const DailyCourseScheduleTable: React.FC<DailyCourseScheduleTableProps> = ({
  data,
}) => {
  ...
  useEffect(() => {
    if (selectedSchool && selectedLevel && selectedClass) {
      setDisplayClasses(
        getClassData(selectedSchool, selectedLevel, selectedClass)
      );
    } else {
      setDisplayClasses([]);
    }
              ...
              <Nav.Item key={schoolType}>
                <Nav.Link
                  ...
                  style={{
                    ...
                    margin: "0 4px",
                    backgroundColor:
                      selectedSchool === schoolType ? "#e9dbff" : "#f5f5fd",
            ...
            <div key={index} className="dropdown">
              <Dropdown>
                <Dropdown.Toggle
                  variant="light"
                  style={{
                    backgroundColor: selectedClass.startsWith(prefix)
                      ? "#e9dbff"
                      : "#f5f5fd",
                    borderRadius: "4px",
                    border: "none",
                ...
                >
                  {`${prefix}/${
                    selectedClass.split("/")[1]?.toUpperCase() || "A"
                  }`}
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  {classes.map((cls) => (
