...
import { generateServiceManagerData } from "../../../../../../../utils/generateServiceManagerData";
import ServiceRoutePlanTable from "./leftSection/ServiceRoutePlanTable";
import ServiceUsagebyDayoftheWeekChart from "./leftSection/ServiceUsagebyDayoftheWeekChart";
import ServiceVehicleInformationTable from "./leftSection/ServiceVehicleInformationTable";
import ParentFeedbackPanelTable from "./leftSection/ParentFeedbackPanelTable";
import ServicePaymentinformationTable from "./leftSection/ServicePaymentinformationTable";
...
const Row10Component: React.FC<Row10Props> = ({ data }) => {
  ...
  return (
    <Row>
      ...
      {/* Takvim  ve Servis Ödeme bilgileri*/}
      <Row>
        <Col xl={7}>
          <Calendar   />
        </Col>
