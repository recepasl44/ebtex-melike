                                        ...
                                        {filter.type === "autocomplete" ? (
                                                ...
                                                <Form.Select
                                                    value={
                                                        typeof filter.value === "string"
                                                            ...
                                                            ? `${(filter.value as any).startDate} - ${(filter.value as any).endDate}`
                                                            : undefined
                                                    }
                                                    onChange={(e) => filter.onChange?.(e.target.value)}
                                                    onClick={(e) =>
                                                        filter.onClick?.((e.target as HTMLSelectElement).value)
                                                    }
                                                    onFocus={filter.onFocus}
                                                    disabled={
                                                        filter.dependencyKey
                                            ...
                                            <InputWithPlus fieldDef={filter} navigate={navigate}>
                                                <Form.Control
                                                    ...
                                                    onChange={(e) => filter.onChange?.(e.target.value)}
                                                    onClick={(e) =>
                                                        filter.onClick?.((e.target as HTMLInputElement).value)
                                                    }
                                                    onFocus={filter.onFocus}
                                                    disabled={
                                                        filter.dependencyKey
