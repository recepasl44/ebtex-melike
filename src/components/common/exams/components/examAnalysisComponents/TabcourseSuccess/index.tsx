...
interface TabcourseSuccessProps {
...
const TabcourseSuccess: React.FC<TabcourseSuccessProps> = ({ initialData }) => {
  ...
  // First column header style - centered like other headers
  ...
  // Cell content with horizontally aligned icons but vertically aligned with cells below
...
export default TabcourseSuccess;
