...
function Option16(props: AnalysisListType): TableRow[] {
    return [
      {
      isHeader: false,
      cells: [
        ...
        { content: "", rowSpan: 2, colSpan:1 , style: { width: "90px",height: "51px"  } },
        { content: "", rowSpan:2 , colSpan:1 ,style: { width: "90px",height: "51px"  } },
        { content: "KATILIM SAYILARI", colSpan: 1,rowSpan:2 ,style: { width: "90",height: "51px"  } },
        { content: "SINIF", rowSpan: 1,colSpan:1 , style: { width: "90px" ,height:26} },
    ...
    },
    {
      ...
      cells: [
        ...
        { content: "Sayısal", colSpan: 1, rowSpan: 2, style: { width: "90px" } },
        { content: "Sıralamalar", rowSpan: 2, colSpan: 5, style: { width: "446px" } },
      ],
    },
     {
      isHeader: true,
    ...
    },
    {
      ...
      cells: [
        ...
        { content: <DYNHeader /> },
        { content: <DYNHeader /> },
        {content: "Toplam" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
        { content: "Sınıf" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
        { content: "Kurum" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
        { content: "İlçe" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
        { content: "İl" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
        { content: "Genel" ,colSpan:1 ,rowSpan:1 ,  style: { width: "90px",textAlign:"center" ,fontSize:"12px" ,fontWeight:"700" }},
         ],
         },
         {
      isHeader: false,
      cells: [
        ...
        { content: `${props.results.general_avarage[0].quiz_result.ordered.class}`, colSpan: 1 },
        { content: `${props.results.general_avarage[0].quiz_result.ordered.branch}`, colSpan: 1 },
        { content: `${props.results.general_avarage[0].quiz_result.ordered.county}`, colSpan: 1 },
        { content: `${props.results.general_avarage[0].quiz_result.ordered.city}`, colSpan: 1 },
        { content: `${props.results.general_avarage[0].quiz_result.ordered.general}`, colSpan: 1 },
          ...
          cells: [
            ...
            { content: `${props.results.branch_avarage[0].quiz_result.ordered.class}`, colSpan: 1 },
            { content: `${props.results.branch_avarage[0].quiz_result.ordered.branch}`, colSpan: 1 },
            { content: `${props.results.branch_avarage[0].quiz_result.ordered.county}`, colSpan: 1 },
            { content: `${props.results.branch_avarage[0].quiz_result.ordered.city}`, colSpan: 1 },
          ],
        },
       {
      cells: [
        ...
        {  content: `${props.results.students[0].quiz_result.ordered.class}`, colSpan: 1},
        {  content: `${props.results.students[0].quiz_result.ordered.branch}`, colSpan: 1},
        {  content: `${props.results.students[0].quiz_result.ordered.county}`, colSpan: 1},
        {  content: `${props.results.students[0].quiz_result.ordered.city}`, colSpan: 1},
      ],
    },
    ];
    }
    export default Option16;
