...
function Option1(props: AnalysisListType): TableRow[] {
  return [
    {
      isHeader: false,
      cells: [
    ...
    },
    {
      ...
      cells: [
        ...
        { content: "", rowSpan: 1, style: { width: "90px", height: "24px" } },
        {
          ...
          style: {
            width: `${
              props.results.students[0].test_booklet[0]?.lessons.length * 90
            }px`,
            height: "24px",
          },
        },
        {
          ...
          style: {
            width: `${
              props.results.students[0].test_booklet[1]?.lessons.length * 90
            }px`,
            height: "24px",
          },
        },
    ...
    },
    {
      cells: [
        ...
        {
          content: `${props.results.branch_avarage[0].quiz_result.general}`,
          colSpan: 1,
        },
        {
    ...
    },
    {
      cells: [
        ...
        {
          content: `${props.results.students[0].quiz_result.general}`,
          colSpan: 1,
        },
        {
