...
function Option14(props: AnalysisListType): TableRow[] {
    return  [
      {
      isHeader: false,
      cells: [
    ...
    },
    {
      ...
      cells: [
        ...
        { content: props.results.general_avarage[0].test_booklet[0]?.name,  colSpan: 1,  rowSpan: 2, },
        { content: props.results.general_avarage[0].test_booklet[1]?.name, colSpan: 1, rowSpan: 2},
        { content: props.results.general_avarage[0].test_booklet[2]?.name, colSpan: 1, rowSpan: 2,},
        { content: props.results.general_avarage[0].test_booklet[3]?.name, colSpan: 1,rowSpan: 2,    },
        { content: "Toplam", rowSpan: 2, style: { width: "90px" } },
        { content: "Puan", colSpan: 1, rowSpan: 3, style: { width: "90px" } },
        { content: "TYT Sıralaması", rowSpan: 2, colSpan: 5 },
      ],
    },
     {
      isHeader: true,
