// F:\xintra_react_ts\src\components\common\InvoiceSummaryTable.tsx
            ...
            },
            {
                ...
                render: (r) => (
                    <div>
                        ...
                        <Button size="sm" onClick={() => navigate(`/invoicedetail/${r.id}`)}>
                            Detay
                        </Button>

                        <Button size="sm" onClick={() => navigate(`/createinvoice/${r.id}`)}>
                            Detay
                        </Button>
                    </div>
