...
import { statusNumbersTable } from "./table";
...
interface StatusNumbersFilterProps {
  StatusNumbersChange: (data: { id: string; name: string }) => void;
}

const StatusNumbersFilter: React.FC<StatusNumbersFilterProps> = ({
  StatusNumbersChange,
}) => {
  const columns = statusNumbersTable();
  ...
  useEffect(() => {
    StatusNumbersChange({ id: studentId, name: inputName });
  }, [studentId, inputName, StatusNumbersChange]);
...
export default StatusNumbersFilter;
