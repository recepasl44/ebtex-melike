/* -------------------------------------------------------------------------- */
/* table.tsx – Personel / Öğretmen Yoklama › Yoklama Sayıları                 */
/* -------------------------------------------------------------------------- */
...
const PollingCountTable: React.FC = () => {
    ...
    const {
        ...
        // backend’de özel aggregation hâzırsa doğrudan döner;
        // değilse FE’de gruplanmış sahte veriler de gösterilebilir.
        stats_only: true,      // <= mümkünse sadece sayıları isteriz
    });
