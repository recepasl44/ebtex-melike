  ...
  return (
    ...
    >
      ...
      <li>
        <Link
          className="dropdown-item d-flex align-items-center"
          to={`${import.meta.env.BASE_URL}pages/file-manager`}
        >
          <i className="fe fe-database p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>
          File Manager
          <SpkBadge variant="primary1" Customclass="text-fixed-white ms-auto fs-9">
            2
          </SpkBadge>
        </Link>
      </li>
