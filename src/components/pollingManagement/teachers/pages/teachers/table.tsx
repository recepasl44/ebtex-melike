/* ------------------------------------------------------------------
 *  Ders Yoklama Tablosu – Öğretmen
 *  path: src/components/common/pollingManagement/teachers/pages/lesson/table.tsx
 * -----------------------------------------------------------------*/
...
interface Row {
    ...
    execute_status: string;  // yönetici durumu
}
...
export default function LessonPollingTable() {
    ...
    /* —— Durum güncelleme —— */
    const isEditable = (r: Row) => !r.execute_status;
    ...
    /* —— Filtreler (col:1 → 4 filtre / satır) —— */
    ...
    return (
        <div>
            ...
            <ReusableTable<Row>
                ...
                showExportButtons
                exportFileName="teacher_polling"
                pageTitle=""
            />
        </div>
    );
