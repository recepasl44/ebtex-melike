/* ------------------------------------------------------------------
 *  Kulüp Planı Modalı   –   path:
 *  src/components/common/pollingManagement/clupsPolling/ClubPlanModal.tsx
 * -----------------------------------------------------------------*/
...
export default function ClubPlanModal({
    ...
    /* —— look-up queries —— (enabled bayraklarına bağlı) */
    ...
    useEffect(() => {
        if (mode === 'update' && fetched) {
            ...
            /* güncelleme modunda tüm veriler lazım */
            setEnabled({
