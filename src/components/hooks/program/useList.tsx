...
export function useProgramsTable(params: ProgramListArg) {
  ...
  const [page, setPage] = useState<number>(typeof params.page === 'number' ? params.page : 1);
  const [pageSize, setPageSize] = useState<number>(typeof params.pageSize === 'number' ? params.pageSize : 10);
