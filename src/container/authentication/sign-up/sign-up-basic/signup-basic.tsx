                                ...
                                <div className="row gy-3">
                                    ...
                                    <Col xl={12}>
                                        ...
                                        <div className="form-check mt-3">
                                            ...
                                            <Link to={`${import.meta.env.BASE_URL}pages/terms-conditions`} className="text-success ms-1"><u>Terms & Conditions</u></Link> and <a className="text-success"><u>Privacy Policy</u></a>
                                        </div>
                                    </Col>
                                </div>
