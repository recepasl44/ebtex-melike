                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <p>An alternative solution is to add a wrapper around the <span
                                className="text-danger">.row</span> with the <span className="text-danger"> .overflow-hidden </span> class:
                            </p>
                            <div className="container overflow-hidden">
                                <div className="row gx-5 gy-2">
                                    <div className="col">
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <p>The gutters between columns in our predefined grid classes can be removed
                                ...
                                </span> and the horizontal <span className="text-danger">padding</span> from all immediate children columns.
                            </p>
