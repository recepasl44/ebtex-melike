...
import { Contentdata, Contentdata1, Contentdata3, Contentdata4 } from "../../../components/common/data/utilities/flexdata";
                        ...
                        <Card.Body>
                            <div className="d-sm-flex mb-3">
                                <div className="flex-shrink-0">
                                    <img className="bd-placeholder-img card-img" src={face6} alt="img" />
                                </div>
