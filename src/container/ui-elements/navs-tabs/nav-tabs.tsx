                                ...
                                <Tab.Content className="" id="myTabContent2">
                                    <Tab.Pane eventKey="a" className=" fade p-0 border-bottom-0 overflow-hidden" id="products-tab-pane"
                                        ...
                                        <div className="table-responsive">
                                            <SpkTablescomponent tableClass="mb-0" header={[{ title: 'Product' }, { title: 'Name' }, { title: 'Category' }, { title: 'Price' }]} >
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <img src={png32} alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Alarm Clock</td>
                                                    <td>Clocks</td>
                            ...
                            <Card.Body className="">
                                <Nav className=" nav-pills mb-3" role="tablist">
                                    ...
                                    <SpkDropdown Customclass="nav-item" toggleas="a" Customtoggleclass="nav-link" Toggletext="Cart" Navigate="#!">
                                        <Link className="dropdown-item" to="#pill-wishlist">Wishlist</Link>
                                        <Link className="dropdown-item" to="#!">Liked</Link>
                                        <Link className="dropdown-item" to="#!">Save For Later
                                        </Link>
                                        <Link to="#!" className="dropdown-item">
                                            <hr className="dropdown-divider" />
                                        </Link>
                                        <Link to="#!" className="dropdown-item">Recently Viewed</Link>
                                    </SpkDropdown>
                                    <Nav.Item>
