...
const ButtonGroups = () => {
    return (
        <Fragment>
            ...
            <Pageheader title="Ui Elements" currentpage="Buttongroup" activepage="Buttongroup" />
