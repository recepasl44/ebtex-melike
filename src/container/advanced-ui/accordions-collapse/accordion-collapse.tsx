...
import { Basicdata, Customdata, Flushdata } from "../../../components/common/data/adavanec-ui/accordionsdata";
            ...
            <Row>
                ...
                <Col xl={6}>
                    <ShowCode title="Always Open Accordion <p class='text-muted subtitle fs-12 fw-normal'>Omit the <code>data-bs-parent</code>
                        ...
                        <SpkAccordions items={Basicdata}  Open={true} />
            ...
            <Row>
                ...
                <Col xl={6}>
                    <ShowCode title="Example" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion14}>
                        <p className="mb-0">
                            <SpkButton Customclass="collapsed m-1" Buttonvariant="primary" aria-controls="example-collapse-text" Buttontoggle="collapse" onClickfunc={() => setOpenb(!openb)}
                                Navigate="#collapseExample">
                                Link with href
                            </SpkButton>
                            <SpkButton Buttonvariant="secondary" Customclass="collapsed m-1" Buttontype="button" onClickfunc={() => setOpenb(!openb)} aria-controls="example-collapse-text" Expand={openb}
