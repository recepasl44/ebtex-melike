          ...
          <Card className="custom-card">
            ...
            <Card.Body className=" p-5 text-center">
              ...
              <div className="row justify-content-center gap-3">
                <Col xxl={3}>
                  <Card className="custom-card shadow-none bg-primary-transparent text-start">
                    <Card.Body className="">
                      <div className="d-flex gap-3 align-items-start flex-wrap flex-xl-nowrap">
                        <span className="avatar avatar-xl bg-primary svg-white flex-shrink-0" id="step-2">
                        ...
                        <div>
                          <h6 className="fw-meidum mb-2">Pick a place.</h6>
                          <span className="fs-12 text-muted">Selecting a destination can be exciting! share your preferences or interests.</span>
                        </div>
                      </div>
                    </Card.Body>
                  </Card>
                ...
                <Col xxl={3}>
                  <Card className="custom-card shadow-none text-start bg-primary1-transparent">
                    <Card.Body className="">
                      <div className="d-flex gap-3 align-items-start flex-wrap flex-xl-nowrap">
                        <span className="avatar avatar-xl bg-primary1 svg-white flex-shrink-0" id="step-3">
                        ...
                        <div>
                          <h6 className="fw-meidum mb-2">Travel Budget</h6>
                          <span className="fs-12">Tips for Saving, Spending, and Making the Most of Every Dollar.</span>
                        </div>
                      </div>
                    </Card.Body>
                  </Card>
                ...
                <Col xxl={3}>
                  <Card className="custom-card shadow-none text-start bg-primary2-transparent">
                    <Card.Body className="">
                      <div className="d-flex gap-3 align-items-start flex-wrap flex-xl-nowrap">
                        <span className="avatar avatar-xl bg-primary2 svg-white flex-shrink-0" id="step-4">
                        ...
                        <div>
                          <h6 className="fw-meidum mb-2">Your Travel Options</h6>
                          <span className="fs-12">Your comprehensive Guide to Smooth Travel Planning</span>
                        </div>
                      </div>
                    </Card.Body>
                  </Card>
                ...
                <Col xxl={3}>
                  <Card className="custom-card shadow-none text-start bg-secondary-transparent">
                    <Card.Body className="">
                      <div className="d-flex gap-3 align-items-start flex-wrap flex-xl-nowrap">
                        <span className="avatar avatar-xl bg-secondary svg-white flex-shrink-0" id="step-6">
                        ...
                        <div>
                          <h6 className="fw-meidum mb-2">Confirm Booking</h6>
                          <span className="fs-12">Verifying every detail and securing reservations for a stress-free trip ahead.</span>
                        </div>
                      </div>
                    </Card.Body>
                  </Card>
