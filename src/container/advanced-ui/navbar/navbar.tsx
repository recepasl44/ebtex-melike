				...
				<Col xl={12}>
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar className="navbar bg-light mb-3">
								<Container fluid>
									<Navbar.Brand href="#!">  <img src={togglelogo} alt="" /></Navbar.Brand>
									<Form className="d-flex" role="search">
							...
							<Navbar className="navbar bg-light">
								<Form className="container-fluid justify-content-start">
									...
									<SpkButton Buttonvariant="outline-secondary" Buttontype="button" Customclass="m-1">Smaller button</SpkButton>
								</Form>
							</Navbar>
						</Card.Body>
					</Card>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary mb-3">
								<Container fluid>
									<Navbar.Brand href='#!'>  <img src={togglewhite} alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary-transparent mb-3">
								<Container fluid>
									<Navbar.Brand href="#!" className="navbar-brand">  <img src={togglelogo} alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
